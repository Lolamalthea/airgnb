...
b = Weapon.new(name: "Self defense rifle", category: "Assault riffle", picture: File.open(Rails.root.join('db/seed/weapon_2.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
b.user = a
b.save
...
d = Weapon.new(name: "WWII rifle", category: "Assault riffle", picture: File.open(Rails.root.join('db/seed/weapon_3.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
d.user = c
d.save
...
f = Weapon.new(name: "Military tank", category: "Heavy weapon", picture: File.open(Rails.root.join('db/seed/weapon_4.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
f.user = e
f.save
...
h = Weapon.new(name: "Feel my gun power", category: "Assault riffle", picture: File.open(Rails.root.join('db/seed/weapon_6.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
h.user = g
h.save
...
j = Weapon.new(name: "My secret passion", category: "Assault riffle", picture: File.open(Rails.root.join('db/seed/weapon_8.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
j.user = i
j.save
...
l = Weapon.new(name: "Secret weapon", category: "Heavy weapon", picture: File.open(Rails.root.join('db/seed/weapon_7.jpg')), description: Faker::Lorem.paragraph(2), address: Faker::Address.street_address + ' ' + Faker::Address.zip_code + ' ' + Faker::Address.city, price: rand(50..1000))
l.user = k
l.save
